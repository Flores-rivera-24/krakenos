# Conectar Frigate (NVR con detección de objetos)
...
existente y hereda su detección. El detector propio (diferencia de grises 32×24) queda
...
- Todo se sirve **por proxy autenticado**: la URL de Frigate/go2rtc **nunca** llega al navegador,
  y el vídeo en vivo usa el mismo modelo de token efímero que las cámaras RTSP.
...
## Verificación con un Frigate real
