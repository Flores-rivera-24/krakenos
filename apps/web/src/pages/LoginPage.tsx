          ...
          <div className="space-y-4 px-5 py-6 text-center">
            ...
            {backupMode ? (
              <div className="space-y-2 text-left">
                ...
                />
                {backupError && (
                  // El resultado de canjear un código de recuperación es lo que
                  // acaba de pasar, igual que el error de contraseña de arriba:
                  // sin anunciarlo, el paso falla en silencio para quien no ve.
                  <p role="alert" className="text-[13px] text-danger">
                    {backupError}
                  </p>
                )}
